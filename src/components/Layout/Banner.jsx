...
import img from "@/assets/illustration.png"; // Perfect – works locally + on Vercel

const Banner = () => {
  return (
    <div className="flex justify-center items-center px-4">
      <div className="max-w-[1042px] w-full mx-auto text-center mt-20 sm:mt-28 md:mt-36">
        <div className="inline-block px-5 py-2 rounded-full bg-[#DFEDE3] text-emerald-700 mb-6 font-manrope font-medium text-sm sm:text-base md:text-lg leading-tight">
          Fast. Secure. Hassle-Free
        </div>

        <h1 className="font-roboto font-extrabold text-[#141414] text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl leading-snug sm:leading-[50px] md:leading-[58px] lg:leading-[72px] xl:leading-[82px] mb-4 sm:mb-5 md:mb-6">
        ...
        <p className="text-[#555555] text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl leading-6 sm:leading-7 md:leading-8 lg:leading-9 font-manrope font-normal mx-auto max-w-[700px] mb-8 md:mb-10 lg:mb-12">
        ...
        <button
          ...
          className="w-[160px] sm:w-[180px] md:w-[192px] lg:w-[210px] xl:w-[220px] 
                     ...
                     transition-all hover:bg-[#0d3f1c] active:scale-95"
        >
          Get Started
        </button>
      </div>
